...
volatile int *dst_test = (volatile int *) 0x08000020;
volatile int *src_test = (volatile int *) 0x08000090;  
...
int main()
{
    ...
    *src_test = 0x12345679;
    *(src_test + 1) = 0x87654322;
    *(src_test + 2) = 0x11111112;

    wordcopy(dst_test, src_test, 3);

    if((*dst_test == *src_test) && (*(dst_test + 1) == *(src_test + 1)) && (*(dst_test + 2) == *(src_test + 2))){
        result = 1;
    } else {
        result = 0;
    }
